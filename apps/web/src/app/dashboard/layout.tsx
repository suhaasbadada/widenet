  ...
  const navItems = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          <path d="M4 5a2 2 0 0 1 2-2h3.5a2 2 0 0 1 1.6.8l1.8 2.4a2 2 0 0 0 1.6.8H18a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z" />
          <path d="M8 13h8" />
          <path d="M8 17h5" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <path d="M15 10h4a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-1" />
        </svg>
      ),
    },
    {
              ...
              if (item.disabled) {
                return (
                  <span
                    ...
                    className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-slate-300 cursor-not-allowed"
                  >
                    {item.icon}
                    <span className="sr-only">{item.name} (Coming soon)</span>
                  </span>
                );
              }
            ...
            if (item.disabled) {
              return (
                <span
                  key={item.path}
                  aria-label={`${item.name} (Coming soon)`}
                  className="shrink-0 px-3 py-2 rounded-lg text-sm font-semibold text-slate-300 cursor-not-allowed"
                >
                  {item.name}
                </span>
              );
